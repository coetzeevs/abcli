...

{
    ...
    echo "Using"
    echo ""
    echo "- [branch-protection.json](https://github.com/coetzeevs/.github/blob/main/.github/config/branch-protection/branch-protection.json)"
    echo "- [repo.json](https://github.com/coetzeevs/.github/blob/main/.github/config/repo.json)"
    echo "- [topics.json](https://github.com/coetzeevs/.github/blob/main/.github/config/topic.json)"
    echo ""
} >>"${GITHUB_STEP_SUMMARY}"
